            ...
            >
              ...
              <div>
                <input
                  ...
                  id="name"
                  name="name"
                  className="shadow-sm bg-[#008E82] border border-[#008E82] text-white text-sm rounded-lg focus:ring-[#008E82]/75 focus:border-[#008E82]/80 block w-full p-2.5"
              ...
              <div>
                <input
                  ...
                  id="subject"
                  name="subject"
                  className="block p-3 w-full text-sm text-white bg-[#008E82] rounded-lg border border-[#008E82] shadow-sm focus:ring-[#008E82]/75 focus:border-[#008E82]/80"
                  placeholder="Subject"
                  required
                />
              </div>
              <div className="sm:col-span-2">
                <textarea
                  ...
                  rows="6"
                  name="message"
                  className="block p-2.5 w-full text-sm text-white bg-[#008E82] rounded-lg shadow-sm border border-[#008E82] focus:ring-[#008E82]/75 focus:border-[#008E82]/80"
          ...
          <div className="flex space-x-6 items-center justify-center mx-auto md:items-start md:flex-col md:space-x-0 md:space-y-10">
            {logos.map((item, index) => (
              <a
                key={index}
                href={item.url}
                className="transition-transform hover:duration-300 hover:transform hover:translate-y-1"
              >
      ...
      <section className="py-8 bg-[#156760] ">
        ...
        <div className="sm:flex mx-auto px-4 space-x-2 sm:items-center sm:justify-center max-w-screen-xl">
          <span className="text-sm text-gray-300 sm:text-center">
            ...
            <span className="hover:underline cursor-pointer"> BlessingIngyape™</span>. All Rights Reserved.
          </span>
        </div>
      </section>
    </>
