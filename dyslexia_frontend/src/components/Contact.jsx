...
const Contact = () => {
    return (
        ...
        <section  className=" pt-[50px] bg-[#156760] mt-[50px] lg:flex lg:pt-[150px]">
          <div className="py-8 px-4 mx-auto max-w-3xl ">
            <h2 className="mb-7 text-4xl tracking-tight font-extrabold text-white dark:text-white">Send me a Message</h2>
          ...
          <div className="py-2 px-4 mx-auto max-w-3xl lg:my-[100px] lg:ml-[-10px]">
            <div className="flex space-x-6 items-center justify-center mx-auto md:justify-start  lg:inline ">
              ...
              <a href="#" className="hover:text-[#51CAC0] ">
                <svg class="w-6 h-6 text-white  hover:text-[#51CAC0] lg:mb-[20px]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 15 15">
              ...
              <a href="#" className="hover:text-[#51CAC0]">
                <svg class="w-6 h-6 text-white  hover:text-[#51CAC0] lg:mb-[20px]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
              ...
              <a href="#" className="hover:text-[#51CAC0]">
                <svg class="w-6 h-6 text-white  hover:text-[#51CAC0] lg:mb-[20px]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" className="hover:text-[#51CAC0]">
                <svg class="w-6 h-6 text-white  hover:text-[#51CAC0] lg:mb-[20px]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
              ...
              <a href="#" className="hover:text-[#51CAC0]">
                <svg class="w-6 h-6 text-white  hover:text-[#51CAC0] lg:mb-[20px]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 14">
