    ...
    <>
      <section className="bg-[#EDFAFC] my-10">
        {heading.map((item, index) => (
          <div key={index} className="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
            <h2 className="mb-8 lg:mb-16 text-3xl font-extrabold tracking-tight font-[Segoe UI] leading-tight text-center text-[#006273] md:text-4xl">{item[1].title}</h2>
