        ...
        <section className="bg-[#EDFAFC] mb-16">
          ...
          <div className="grid max-w-screen-xl items-center px-4 py-8 mx-auto md:gap-8 xl:gap-0 md:py-16 md:grid-cols-12">
              ...
              <div className="ml-auto place-self-center text-center md:text-left md:col-span-7">
                  ...
                  <a href="#" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border border-gray-300 rounded-lg hover:bg-[#006273]/10 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                      Speak to Sales
                  </a> 
              </div>             
          </div>
